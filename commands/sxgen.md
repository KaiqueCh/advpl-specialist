---
description: Generate Protheus SX data dictionary configuration scripts - SX2 tables, SX3 fields, SIX indexes, SXG groups, SXA folders, SX1 questions, SX5 generic tables, SXB lookups, SX7 triggers
...
|------|------------|---------|
| `--type` | SX type: `sx2`, `sx3`, `six`, `sxg`, `sxa`, `sx1`, `sx5`, `sxb`, `sx7` | Auto-detect from description |
