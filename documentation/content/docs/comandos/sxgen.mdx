---
title: /sxgen
description: Gera scripts de configuracao do dicionario de dados SX do Protheus - tabelas SX2, campos SX3, indices SIX, grupos SXG, pastas SXA, perguntas SX1, tabelas genericas SX5, consultas SXB e gatilhos SX7
---
...
|------|-----------|--------|
| `--type` | Tipo SX: `sx2`, `sx3`, `six`, `sxg`, `sxa`, `sx1`, `sx5`, `sxb`, `sx7` | Auto-detectar a partir da descricao |
...
| Tipo | O que gera |
|------|------------|
| `sx2` | Mapeamento de tabelas (X2_ARQUIVO, X2_CHAVE, X2_PATH, X2_MODO) |
...
| `sxg` | Grupos de campos / tamanhos padronizados (XG_GRUPO, XG_TAMANHO, XG_DECIMAL) |
| `sxa` | Pastas de cadastro (XA_ALIAS, XA_ORDEM, XA_DESCRIC) |
...
| `sxb` | Consultas padrao / lookups F3 (XB_ALIAS, XB_TIPO, XB_SEQ, XB_CHAVE) |
| `sx7` | Gatilhos de campo (X7_CAMPO, X7_SEQUENC, X7_REGRA, X7_CDOMAIN) |
